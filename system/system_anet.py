...
class LightningSystem(pl.LightningModule):
    ...
    def add_model_specific_args(parent_parser):
        ...
        parser.add_argument("--model-name", type=str, default="dev0.5_anet")
        ...
        parser.add_argument("--num-segments", type=int, default=80)
        ...
        # parser.add_argument("--tIoU_thresh",
        #                     type=float,
        #                     nargs='*',
        #                     default=[0.1, 0.3, 0.5])
...
class Model_BaS(nn.Module):
    def __init__(self, args):
        ...
        self.attention = nn.Sequential(
            nn.Conv1d(n_feature, 512, 3, padding=1),
            nn.LeakyReLU(0.2),
            nn.Conv1d(512, 512, 3, padding=1),
            nn.LeakyReLU(0.2),
            # nn.BatchNorm1d(512),
            # nn.Conv1d(512, 512, 13, padding=6, groups=512),
            # nn.LeakyReLU(0.2),
            nn.Conv1d(512, 1, 1),
            nn.Sigmoid(),
            (nn.AvgPool1d(
